...
<%@ page import="com.sameer.JobPortal.model.JobPost" %>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="alert alert-success text-center" role="alert">
                <strong>Success!</strong> Your job post has been added successfully.
            </div>
...
<footer class="text-center bg-clr py-3 mt-5">
